...
function displayConfirmation(booking) {
    const receiptDiv = document.getElementById('confirmationReceipt');
    
    // Format dates for display
    const arrivalFormatted = new Date(booking.arrival).toLocaleString('en-GB', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
        hour: '2-digit',
    ...
    const departureFormatted = new Date(booking.departure).toLocaleString('en-GB', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
        hour: '2-digit',
    ...
    receiptDiv.innerHTML = `
        ...
        <div class="receipt-item">
            ...
            <span>${booking.parking_name}</span>
        </div>
        ...
        <div class="receipt-item" style="font-size: 1.2em; margin-top: 15px;">
            ...
            <strong style="color: #F69074;">€${booking.total_cost.toFixed(2)}</strong>
        </div>
        
        <div class="barcode">
            <p style="color: #02A2A2; font-weight: bold; margin-bottom: 10px;">Scan at Parking Entrance</p>
            <div class="barcode-image"></div>
            <p style="font-family: monospace; font-size: 0.9em;">${booking.barcode}</p>
        </div>
